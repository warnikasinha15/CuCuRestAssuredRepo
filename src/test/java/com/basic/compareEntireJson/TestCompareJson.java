...
public class TestCompareJson {
	...
	public void user_compare_two_json_string(){
		...
		//resp=RestAssured.given().relaxedHTTP.....// if this then it will take actual string at run time.
		// and the expected line should be changed as below
		
		//Case1: Extra field in actual : PASS
		//String expected1=resp.asString();// if above case
